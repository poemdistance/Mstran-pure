...
#define MOUSE_RIGHT_PRESS  ( 3 )
#define MOUSE_MIDDLE_PRESS  ( 2 )
        ...
        select_area_filter_data *data)
{
    ...
    if (event->button == MOUSE_RIGHT_PRESS )
    {
        data->rect.x = 0;
        data->rect.y = 0;
        data->rect.width  = 0;
...
emit_select_callback_in_idle (gpointer user_data)
{
    ...
    static void
screenshot_check_left_button_click (CallbackData *cb_data)
{
        ...
        gpointer callback_data)
{
    ...
    screenshot_check_left_button_click ( cb_data );
}
